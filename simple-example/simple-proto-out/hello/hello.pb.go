...
type HelloRequest struct {
	...
	Req string `protobuf:"bytes,1,opt,name=req,proto3" json:"req,omitempty"` // 消息中的参数序号
}
...
func (x *HelloReply) GetResp() string {
	if x != nil {
		return x.Resp
	}
	return ""
...
func (x *HelloReply) GetLastUpdate() *timestamp.Timestamp {
	if x != nil {
		return x.LastUpdate
	}
	return nil
...
var file_hello_proto_rawDesc = []byte{
	...
	0x28, 0x09, 0x52, 0x03, 0x72, 0x65, 0x71, 0x22, 0x5d, 0x0a, 0x0a, 0x48, 0x65, 0x6c, 0x6c, 0x6f,
	0x52, 0x65, 0x70, 0x6c, 0x79, 0x12, 0x12, 0x0a, 0x04, 0x72, 0x65, 0x73, 0x70, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x04, 0x72, 0x65, 0x73, 0x70, 0x12, 0x3b, 0x0a, 0x0b, 0x6c, 0x61, 0x73,
	...
	0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x32, 0x3b, 0x0a, 0x05, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x12,
	0x32, 0x0a, 0x08, 0x53, 0x61, 0x79, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x12, 0x13, 0x2e, 0x68, 0x65,
	...
	0x70, 0x6c, 0x79, 0x42, 0x0d, 0x5a, 0x0b, 0x68, 0x65, 0x6c, 0x6c, 0x6f, 0x3b, 0x68, 0x65, 0x6c,
...
var file_hello_proto_depIdxs = []int32{
	2, // 0: hello.HelloReply.last_update:type_name -> google.protobuf.Timestamp
	0, // 1: hello.Hello.SayHello:input_type -> hello.HelloRequest
	1, // 2: hello.Hello.SayHello:output_type -> hello.HelloReply
